...
setwd("/Users/mac/Documents/Studies/GettingAndCleaningData/")
...
dataset.melt <-melt(as.data.table(dataset.filtered), id = c('activitylabel', 'subject'), measure.vars = features.colnames)
